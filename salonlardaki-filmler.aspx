<%@ Page Title="" Language="C#" MasterPageFile="~/FilmArsiv.Master" AutoEventWireup="true" CodeBehind="salonlardaki-filmler.aspx.cs" Inherits="FilmVeriTabaniUygulamasi_ENOCA.salonlardaki_filmler" %>
    ...
    <div style="overflow: hidden; width: 100%;">
        ...
        <div style="margin: 10px; width: 20%; float: left;">
            <div style="margin: 10px 0px 0px 25px;">
                <input style="width: auto" class="form-control" id="myInput" type="text" placeholder="Salon Adı Giriniz...">
            </div>
        ...
        <div style="margin: 10px; width: 70%; float: right;">
            <table class="table">
                <thead class="table-dark">
                    <tr>
                        <th style="width: auto; height: auto;">Salon Adı</th>
                        <th style="width: auto; height: auto;">Film Adı</th>
                        <th style="width: auto; height: auto;">Yayın Tarihi</th>
                    </tr>
                </thead>
                <tbody id="myTable">
                    <tr style="height: auto; font-family: 'Arial'">
                        <asp:Repeater ID="rptListe" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td class="table-primary" style="width: 150px;"><%# DataBinder.Eval(Container.DataItem, "SalonAdi") %></td>
